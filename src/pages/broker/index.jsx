    ...
    return (
        <>
            <div className=" w-11/12 mx-auto bg-gradient-to-tr from-white/10 to-white/20 backdrop-blur-md rounded-lg shadow-md p-8 mt-5">
                <div className="mb-5 text-white font-normal text-2xl flex justify-between items-center ml-[25px]">
                    <svg
                ...
                <div className="h-[800px] border border-white p-3 text-2xl text-white">
                    Any funcs
                </div>
            </div>
        </>
