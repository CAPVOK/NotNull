...
export const SideBar = () => {
    ...
    return (
        <div className=" hidden text-white w-3/12 bg-white/30 backdrop-blur-sm top-0 left-0 sm:flex sm:flex-col place-content-center text-center text-4xl h-[full]" >
            <p className="my-2 mx-1">Список брокеров</p>
