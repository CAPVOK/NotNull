        ...
        <>
            ...
            <div className="w-full h-full mt-12 md:mt-0">
                <div className={`flex flex-col lg:grid lg:gap-6 2xl:gap-8 lg:grid-cols-12 2xl:pb-8 ml-2 pt-4 px-6`}>
                    {/* Краснов */}
                    <div className={`beforeAnimated1 ${isAnimated ? 'afterAnimated' : ''} bg-amber-500 lg:order-1 lg:row-span-1 lg:col-span-7 rounded-lg shadow-xl mb-5 lg:mb-0`}>
                    ...
                    {/* Каримов */}
                    <div className={`beforeAnimated2 ${isAnimated ? 'afterAnimated' : ''} bg-indigo-600 lg:order-1 lg:row-span-1 lg:col-span-5 rounded-lg shadow-xl mb-5 lg:mb-0`}>
                        <div className="mx-6 my-8 2xl:mx-10 flex flex-row items-center">
                    ...
                    {/* Кабанец */}
                    <div className={`beforeAnimated1 ${isAnimated ? 'afterAnimated' : ''} bg-indigo-600 lg:order-3 lg:row-span-1 lg:col-span-5 rounded-lg shadow-xl mb-5 lg:mb-0`}>
                        <div className="mx-6 my-8 2xl:mx-10 flex flex-row items-center">
                    ...
                    {/* Толкачeв */}
                    <div className={`beforeAnimated2 ${isAnimated ? 'afterAnimated' : ''} bg-amber-500 lg:order-4 lg:row-span-1 lg:col-span-7 rounded-lg shadow-xl mb-5 lg:mb-0`}>
                        <div className="mx-6 my-8 2xl:mx-10 flex flex-row items-center">
